...
<main class="font-merriweather">
    <div class="relative container bg-purple-600 text-white p-5 rounded-lg mx-auto my-10 max-w-3xl">
        <div class="flex flex-col md:flex-row justify-between items-center">
            <div class="flex-1 text-center mb-4 md:mb-0">
                <h1 class="text-3xl text-purple-300">About Me</h1>
            </div>
