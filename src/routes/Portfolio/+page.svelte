...
<style>
  ...
  .gallery {
      ...
      grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); /* Responsive columns for image mapping */
  }
  ...
  @media (max-width: 768px) {
      ...
      .we-manage-gallery, .bloggy-gallery {
          grid-template-columns: 1fr; /* Single column for WeManage and Bloggy sections on mobile */
      }
  }

  @media (max-width: 480px) {
      .gallery-title {
          font-size: 2rem; /* Slightly smaller title on small screens */
      }
  }
</style>
